...
export const openingGateSchema: SectionSchema = {
  ...
  fields: [
    ...
    { key: 'gatePhotos', label: { id: 'Foto bintang jatuh', en: 'Shooting photos' }, type: 'imageArray', help: { id: 'Foto yang melayang di gerbang pembuka', en: 'Photos drifting across the opening gate' } },
  ],
}
