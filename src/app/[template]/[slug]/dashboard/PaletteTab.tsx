...
const menuBtn: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', gap: 9, width: '100%', minWidth: 0, height: 36, padding: '1px 16px 0 16px', lineHeight: 1, borderRadius: 'var(--radius-pill)', border: '1px solid', fontFamily: 'var(--font-body, system-ui)', fontSize: 13, letterSpacing: '0.01em', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', cursor: 'pointer', transition: 'color 0.3s ease, border-color 0.3s ease, background 0.3s ease' }
const bullet: React.CSSProperties = { width: 9, height: 9, borderRadius: 'var(--radius-round)', flex: '0 0 auto', transition: 'transform 0.3s ease' }
...
const swatch: React.CSSProperties = { width: 28, height: 28, borderRadius: 'var(--radius-round)', border: '1px solid', boxShadow: '0 4px 12px rgba(0,0,0,0.18)' }
