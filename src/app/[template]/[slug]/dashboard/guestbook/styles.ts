...
export const ghostBtn: React.CSSProperties = { padding: '8px 14px', borderRadius: 'var(--radius-pill)', border: '1px solid rgba(42,33,24,0.2)', background: 'transparent', cursor: 'pointer', fontSize: 12, letterSpacing: '0.1em' }
export const primaryBtn: React.CSSProperties = { padding: '8px 16px', borderRadius: 'var(--radius-pill)', border: 'none', background: '#2A2118', color: '#F5EFE3', cursor: 'pointer', fontSize: 12, letterSpacing: '0.12em', textTransform: 'uppercase' }
export const filterBtn: React.CSSProperties = { padding: '8px 12px', borderRadius: 'var(--radius-pill)', border: '1px solid rgba(42,33,24,0.16)', background: 'transparent', cursor: 'pointer', fontSize: 12 }
export const filterBtnActive: React.CSSProperties = { ...filterBtn, background: '#2A2118', color: '#F5EFE3', borderColor: '#2A2118' }
export const statBox: React.CSSProperties = { background: '#fff', borderRadius: 12, padding: 16, border: '1px solid rgba(42,33,24,0.06)' }
...
export const statValue: React.CSSProperties = { margin: '6px 0 0', fontFamily: 'var(--font-display, serif)', fontStyle: 'normal', fontSize: 22 }
...
export const badgeRsvp: React.CSSProperties = { display: 'inline-block', padding: '3px 9px', borderRadius: 'var(--radius-pill)', fontSize: 11, background: 'rgba(45,140,78,0.12)', color: '#2D8C4E', whiteSpace: 'nowrap' }
export const badgeWalkin: React.CSSProperties = { display: 'inline-block', padding: '3px 9px', borderRadius: 'var(--radius-pill)', fontSize: 11, background: 'rgba(232,85,62,0.12)', color: '#E8553E', whiteSpace: 'nowrap' }
