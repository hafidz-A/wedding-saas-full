...
export const PALETTES = {
  ...
  cosmicDark: {
    ...
    bg:        "#06061a",
    bgSoft:    "#0e0c24",
    surface:   "rgba(14, 12, 36, 0.88)",
    fg:        "#ece5f6",
    fgMute:    "rgba(236, 229, 246, 0.72)",
    fgFaint:   "rgba(236, 229, 246, 0.62)",
  ...
  nebulaDark: {
    id: "nebulaDark",
    label: "Golden Hour Noir",
    bg:        "#0d0a07",
    bgSoft:    "#1a1410",
    surface:   "rgba(26, 20, 16, 0.88)",
    fg:        "#f8efd9",
    fgMute:    "rgba(248, 239, 217, 0.72)",
    fgFaint:   "rgba(248, 239, 217, 0.62)",
    line:      "rgba(255, 255, 255, 0.08)",
    lineSoft:  "rgba(255, 255, 255, 0.04)",
    accent:    "#e8b86a",
  ...
  roseDark: {
    ...
    bg:        "#100608",
    bgSoft:    "#1f0d12",
    surface:   "rgba(31, 13, 18, 0.88)",
    fg:        "#fae8ea",
    fgMute:    "rgba(250, 232, 234, 0.72)",
    fgFaint:   "rgba(250, 232, 234, 0.62)",
    line:      "rgba(255, 255, 255, 0.08)",
    lineSoft:  "rgba(255, 255, 255, 0.04)",
    accent:    "#f08aa6",
  ...
  emeraldDark: {
    ...
    bg:        "#04100b",
    bgSoft:    "#0c1f17",
    surface:   "rgba(12, 31, 23, 0.88)",
    fg:        "#e3f3ec",
    fgMute:    "rgba(227, 243, 236, 0.72)",
    fgFaint:   "rgba(227, 243, 236, 0.62)",
    line:      "rgba(255, 255, 255, 0.08)",
    lineSoft:  "rgba(255, 255, 255, 0.04)",
    accent:    "#7be0a9",
