  ...
  id: {
    ...
    showcase: {
      ...
      byTemplate: {
        lovebirds: {
          tagline: 'Sinematik & hangat',
          body: 'Kartu foto polaroid, animasi botanical, dan section lengkap (RSVP, gift, galeri, guestbook).',
        },
        solary: {
          tagline: 'Futuristik & berani',
          body: 'Tata surya 3D, perjalanan antar-planet saat scroll, dan palette switcher.',
        },
      },
    },
    howItWorks: {
  ...
  en: {
    ...
    showcase: {
      ...
      byTemplate: {
        lovebirds: {
          tagline: 'Cinematic & warm',
          body: 'Polaroid photo cards, botanical animation, and a full set of sections (RSVP, gift, gallery, guestbook).',
        },
        solary: {
          tagline: 'Futuristic & bold',
          body: 'A 3D solar system, inter-planet scroll journey, and a palette switcher.',
        },
      },
    },
    howItWorks: {
