  ...
  id: {
    ...
    tabs: {
      ...
      music: {
        ...
        sourceLabel: 'Sumber musik',
        sources: { upload: 'Upload MP3', url: 'Link audio', youtube: 'YouTube', library: 'Pustaka' },
        urlHelp: 'Tempel link langsung ke file audio (mp3/ogg/wav) yang sudah dihosting di tempat lain.',
        ytDetected: 'Video YouTube terdeteksi ✓',
        ytInvalid: 'Link YouTube tidak dikenali. Tempel link "watch" atau youtu.be.',
        ytHelp: 'Tempel link YouTube. Catatan: tamu perlu menekan "Putar" dulu untuk memulai (autoplay diblokir browser), dan kadang muncul iklan.',
        libraryHelp: 'Pilih salah satu lagu bawaan bebas-royalti — tanpa upload atau link.',
        s2: '2. Teks popup',
        fTitle: 'Judul',
        fSubtitle: 'Subjudul',
  ...
  en: {
    ...
    tabs: {
      ...
      music: {
        ...
        sources: { upload: 'Upload MP3', url: 'Audio link', youtube: 'YouTube', library: 'Library' },
        urlHelp: 'Paste a direct link to an audio file (mp3/ogg/wav) hosted elsewhere.',
        ytDetected: 'YouTube video detected ✓',
        ytInvalid: 'Unrecognised YouTube link. Paste a "watch" or youtu.be link.',
        ytHelp: 'Paste a YouTube link. Note: guests must tap "Play" first to start (browsers block autoplay), and ads may appear.',
        libraryHelp: 'Pick one of the built-in royalty-free tracks — no upload or link needed.',
        s2: '2. Popup wording',
        fTitle: 'Title',
        fSubtitle: 'Subtitle',
