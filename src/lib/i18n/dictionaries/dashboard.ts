      ...
      tutorial: {
        ...
        editor: {
          ...
          tips: [
            ...
            'Mau menukar bagian yang terhalang section terkunci (mis. melewati RSVP, Hadiah, atau Footer)? Pakai mode "Tukar" — yang terkunci tetap di tempatnya, dua bagian bebas saling bertukar. Mode "Geser" akan menolak bila harus melewati yang terkunci.',
          ],
          shots: {
        ...
        solary: {
          ...
          editor: {
            ...
            tips: [
              ...
              'Setiap daftar foto punya batas maksimal — lihat angka "n/maks" di sebelah judulnya. Tombol + Tambah otomatis mati saat penuh.',
              'Ingin menukar dua planet yang terhalang planet terkunci (Galeri, RSVP, Hadiah, atau Penutup)? Pilih mode "Tukar" — yang terkunci tetap di orbitnya, dua planet bebas saling bertukar tempat.',
            ],
            shots: {
          ...
          faq: {
            ...
            faqs: [
              ...
              { q: 'Bagaimana menukar dua planet yang terhalang planet terkunci?', a: 'Ganti mode reorder dari "Geser" ke "Tukar" di atas daftar planet, lalu seret satu planet bebas ke planet bebas lain. "Tukar" menukar posisi keduanya tanpa menggeser planet terkunci (Galeri, RSVP, Hadiah, Gerbang Pembuka, Penutup). Mode "Geser" akan menolak bila gerakannya harus melewati planet terkunci.' },
      ...
      tutorial: {
        ...
        editor: {
          ...
          tips: [
            ...
            'Need to move a section past a locked one (e.g. across RSVP, Gifts, or Footer)? Use "Swap" mode — the locked sections stay put while the two free sections trade places. "Move" mode refuses when it would have to cross a locked section.',
          ],
          shots: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'How do I move a section past a locked one?',
              a: 'In the Editor, switch the reorder mode from "Move" to "Swap" (above the section list), then drag one free section onto another. "Swap" exchanges their positions without shifting the locked sections (Hero, Footer, RSVP, Gifts) between them. "Move" inserts instead, and refuses when the move would have to cross a locked section.' },
          ],
          shots: {},
        },
        // Solary-specific copy. Headings & navTitle are shared above; TutorialTab
        ...
        solary: {
          ...
          editor: {
            ...
            tips: [
              ...
              'Every photo list has a maximum — see the "n/max" counter next to its title. The + Add button disables automatically when full.',
              'Want to swap two planets blocked by a locked one (Gallery, RSVP, Gifts, or Closing)? Pick "Swap" mode — the locked planet stays in its orbit while the two free planets trade places.',
            ],
            shots: {
          ...
          faq: {
            ...
            faqs: [
              ...
              { q: 'How do I swap two planets blocked by a locked one?', a: 'Switch the reorder mode from "Move" to "Swap" above the planet list, then drag one free planet onto another. "Swap" exchanges their positions without shifting locked planets (Gallery, RSVP, Gifts, Opening, Closing). "Move" refuses when the move would have to cross a locked planet.' },
